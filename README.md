...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="/css/build/pages/dgallery/template_normal.min.css?v=54889f7cf7801e47e85eb400d70951c744da3804" />
<link rel="stylesheet" type="text/css" href="/public/lib/photoswipe/dist/photoswipe.css" />
...
<title>App Page</title>
    ...
    <meta property="og:url"
          content="http://qrco.de/bf9XOr?trackSharing=1"/>
    ...
    <meta name="twitter:url" content="http://qrco.de/bf9XOr?trackSharing=1">
...
<body ng-app="app" id="dvideo-body" ng-controller="ComplexController" class="sh-body" ng-style="getBodyStyles()">
    ...
    <div class="sh-bar">
        <div class="sh-container" style="position: relative;">
            <i class="sh-bar__share icon icon-event-share" data-test="share-external-button" id="share-fab-button"></i>
        </div>
    </div>

    <div class="sh-background" ng-style="getBackgroundStyles()"></div>
    ...
    <div class="sh-page__title" data-test="title" ng-show="view.code.title"
         ng-class="{'sh-page__title--more-space': !view.code.description && !view.code.button.label}">{{ view.code.title }}</div>

    <div class="sh-page__description" ng-show="view.code.description && view.code.description.length <= 140"><!--
        --><span class="sh-page__description-text">{{ view.code.description }}</span>
    </div>

    <div class="sh-page__description" ng-show="view.code.description.length > 140 && showDescription"><!--
        --><span class="sh-page__description-text">{{ view.code.description }}</span>&nbsp;<!--
        --><span class="sh-page__less" ng-click="showDescription = false">Less</span>
    </div>

    <div class="sh-page__description" ng-show="view.code.description.length > 140 && !showDescription"><!--
        --><span class="sh-page__description-text">{{ view.code.description | limitTo:140 }}&hellip;</span>&nbsp;<!--
        --><span class="sh-page__more" ng-click="showDescription = true">More</span>
    </div>

    <div ng-show="view.code.button.label">
        <a class="sh-button"
           ng-style="{color: view.code.color1, backgroundColor: isColorLight(view.code.color1) ? '#333' : '#fff'}"
    ...
    <div ng-if="!useGridView()">
        <sh-gallery-image ng-repeat="image in view.code.images track by $index"></sh-gallery-image>
    </div>

    <div class="sh-columns" ng-if="useGridView()">
        <div class="sh-column">
            <sh-gallery-image ng-repeat="image in view.code.images track by $index" ng-hide="$index % 2"></sh-gallery-image>
        </div>
        <div class="sh-column">
            <sh-gallery-image ng-repeat="image in view.code.images track by $index" ng-show="$index % 2"></sh-gallery-image>
        </div>
    </div>

    <div ng-show="view.code.website" class="sh-page__website-container">
        <a class="sh-page__website" href="{{ view.code.website | normalizeUrl }}" target="_blank">
...
<div class="fabs" id="shareFab2">
    <div class="fixed-blur-bgd">
        <div class="chat">
            <div class="fab-body">
                <div class="icon-fab-close icon-event-close" data-test="share-modal-close-button"></div>
                <div class="fab-header" ng-style="{color: view.code.color2}">Share page</div>
                <ul>
                    <li>
                        <i class="icon-fab-share-facebook icon-event-facebook"></i>
                        <a data-test="share-modal-option" href="https://www.facebook.com/sharer/sharer.php?u=https://qrco.de/bf9XOr?trackSharing=1" target="_blank">Facebook</a>
                    </li>
                    <li>
                        <i class="icon-fab-share-x icon-event-x"></i>
                        <a data-test="share-modal-option" href="https://twitter.com/share?url=https://qrco.de/bf9XOr?trackSharing=1" target="_blank">X</a>
                    </li>
                    <li>
                        <i class="icon-fab-share-email icon-event-email"></i>
                        <a data-test="share-modal-option" href="mailto:?body=https://qrco.de/bf9XOr?trackSharing=1" target="_blank">Email</a>
                    </li>
                    <li>
                        <i class="icon-fab-share-message icon-event-message"></i>
                        <span id="shortUrl" style="display: none;">https://qrco.de/bf9XOr?trackSharing=1</span>
...
<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__ui pswp__ui--hidden" data-test="image-zoom-wrapper">
...
<script type="text/javascript" src="/public/lib/jquery/dist/jquery.min.js?v=54889f7cf7801e47e85eb400d70951c744da3804"></script>
<script type="text/javascript" src="/js/build/angular.rendering.min.js?v=54889f7cf7801e47e85eb400d70951c744da3804"></script>
<script type="text/javascript" src="/public/lib/photoswipe/dist/photoswipe.min.js"></script>
<script type="text/javascript" src="/public/lib/photoswipe/dist/photoswipe-ui-default.min.js"></script>
<script type="text/javascript">
/*<![CDATA[*/
        ...
        return {
            ...
            template:
                '<div class="sh-image" ng-click="openGallery(image)" ng-style="getImageContainerStyle(image)">' +
                    ...
                    '<img class="sh-image__image" data-test="main-image" ng-src="{{ image.url }}" ng-class="{&apos;sh-image__image--loaded&apos;: imageUrl}">' +
                '</div>',
    ...
    app.controller('ComplexController', function ($scope, $controller, $sce, $rootScope, $filter, previewService, $window, $log, http, $timeout) {
            ...
            previewService.pushData({"form":[{"section_design":{"fold":false}},{"section_upload":{"fold":false}},{"section_basic_info":{"fold":false}},{"section_welcome_screen":{"fold":false}}],"code":{"files":[{"name":"57224422_1.png","type":"image\/png","size":1453152,"progress":100,"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57349152_1.png?0.04124480469740199"},{"name":"57224427_1.png","type":"image\/png","size":2072239,"progress":100,"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57349153_1.png?0.9509134566068299"}],"images":[{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/46763083_11.png?0.9947512126210886","name":"1.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/46763088_14.png?0.06645688238063108","name":"2.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/46763086_27.png?0.08309581654152365","name":"3.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224428_1.png?0.7366594962944002","name":"5.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224420_1.png?0.1346528193566504","name":"7.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57227657_1.png?0.4170443236086866","name":"8.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224425_1.png?0.7905277121688504","name":"9.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57349152_1.png?0.04124480469740199","name":"57224422_1.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57349153_1.png?0.9509134566068299","name":"57224427_1.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57227656_1.png?0.12412318525197097","name":"10.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224421_1.png?0.571493359994261","name":"11.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224423_1.png?0.3199356468594433","name":"12.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57224429_1.png?0.2571981209952583","name":"13.png","caption":"","progress":100,"width":1920,"height":1080},{"url":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/57285055_1.png?0.986893236147003","name":"56292326_1.png","caption":"","progress":100,"width":1920,"height":1080}],"useGridView":false,"color1":"#f70724","color2":"#3c4245","welcome_extra":{"zoom":150,"background":"#ffffff"},"button":{"url":""}},"showPreview":0,"welcome_screen":"https:\/\/qrcgcustomers.s3-eu-west-1.amazonaws.com\/account24888462\/46763064_1.png?0.26876401046393894"});
